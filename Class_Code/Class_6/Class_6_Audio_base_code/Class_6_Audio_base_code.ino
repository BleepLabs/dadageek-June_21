...
AudioSynthSimpleDrum     drum2;          //xy=197,329
AudioSynthSimpleDrum     drum1;          //xy=205,290
AudioSynthWaveform       waveform2;      //xy=222,236
AudioSynthWaveform       waveform1;      //xy=232,194
AudioMixer4              mixer1;         //xy=427,288
AudioOutputAnalog        dac1;           //xy=616,289
...
void loop() {
  ...
  if (current_time - prev_time[2] > 5) { //slowing  down analog reads a little makes them less noisy
    ...
    note_select2 = map(analogRead(A1), 0, 4095, 30, 70);
